...
const AboutMe = () => {
        ...
        At the time of writing I am playing Death Stranding, Red Dead Redemption 2 with still the occasional game of Mortal Kombat 11 game in between because I just love the MK universe ever since having to hide the first one under my bed to play it at night when I was little. I have started some small game development passion projects as well and will probably link to it somewhere here when there is something to show. 
                    </p>
                </div>
                </div>
            </div>
