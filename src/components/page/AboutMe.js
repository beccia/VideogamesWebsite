...
const AboutMe = () => {
        return (
            <div className="article">
                ...
                <div className="article-main-text">
                    <p>
                    I am currently 32 years old and living in a small country called The Netherlands, but I’ll keep it videogame related from here on. <br/><br/>
        ...
        At the time of writing I am playing Death Stranding, Red Dead Redemption 2 with still the occasional game of Mortal Kombat 11 game in between because I just love the MK universe ever since having to hide the first one under my bed to play it at night when I was little. I work as a software engineer and have started some small game development passion projects and will probably link to it somewhere here when there is something to show.
                    </p>
                </div>
                </div>
            </div>
