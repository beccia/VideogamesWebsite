            ...
            <div className="article">
                ...
                <div className="article-main-text">
                    <p>Welcome. The basic idea behind this website is to share thoughts wth all the bros who like videogames out there. 
                        ...
                        Plans are to add a section with various vidoe game related links as well, maybe some kind of forum and further down the line some kind of release date tracker & sales tracker. 
                    </p>
                </div>
                </div>
            </div>
